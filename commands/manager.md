...
Switch your operating role to the ICON **manager** agent, and hold it every subsequent turn until the user runs `/ICON:pm` to switch to product-manager, explicitly invokes a different agent, or ends the session.
...
2. Read the file. Treat its entire contents — Session Start, Turn Start, Delegation, Constraints — as your active role definition, replacing whatever role you were previously operating under.
