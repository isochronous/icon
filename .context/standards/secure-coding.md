...
- See also: [shell portability Rule 4](shell-portability/rules/004-grep-dash-leading-patterns.md) — `grep` dash-argument guidance this standard's Rule 6 cross-references
